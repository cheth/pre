...
/*
            if ($this->isPowerCharacter($current_character, $previous_character, $current_line)) {
                if ($this->isCompleteVerb($current_character, $previous_character, $current_line)) {
                    if ($this->isPairedVerbClosing) {
                        $this->processStackedVerbs();
                        $this->processCurrentVerb();
                    }
                    if ($this->isPairedVerbOpening) {
                        $this->stackVerb();
                    };    
                    if (!$this->isPairedVerb) {
                        $this->processVerb($current_character, $previous_character, $current_line);
                    };
                    continue;    
                }
            } else {
                $this->pushStringStack($current_character);
            }
*/
    ...
    *------------------
    * params: <string> text to add to output
    *------------------
